  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex justify-between items-start">
            <div>
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-50 to-pink-50 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Platform Commission</p>
              <p className="text-3xl font-bold">₹30.21L</p>
              <div className="flex items-center gap-1 text-green-600 text-sm mt-2">
                <ArrowUp className="w-4 h-4" />
        ...
        <Card className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Active Vendors</p>
              <p className="text-3xl font-bold">247</p>
              <p className="text-sm text-muted-foreground mt-2">12 pending verification</p>
            </div>
            <Store className="w-12 h-12 text-green-300" />
          </div>
        </Card>

        <Card className="p-6 bg-gradient-to-br from-orange-50 to-amber-50 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Active Users</p>
              <p className="text-3xl font-bold">5,432</p>
              <p className="text-sm text-muted-foreground mt-2">+234 this week</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
          <h3 className="text-lg font-bold mb-4">Revenue Trend (6 Months)</h3>
        ...
        <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
              ...
              <span className="text-2xl font-bold text-blue-600">8,547</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
              <span className="text-sm font-semibold">Satisfied Customers</span>
              <span className="text-2xl font-bold text-green-600">4,890</span>
            </div>
      ...
      <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 border-l-4 border-green-500 bg-green-50">
            <div>
              <p className="font-semibold">New Vendor Verified</p>
              <p className="text-sm text-muted-foreground">DJ Masters joined the platform</p>
            </div>
            <CheckCircle className="w-5 h-5 text-green-600" />
          </div>
          <div className="flex items-center justify-between p-3 border-l-4 border-blue-500 bg-blue-50">
            <div>
              <p className="font-semibold">₹2.5L Booking Completed</p>
              <p className="text-sm text-muted-foreground">Sharma Wedding event successfully concluded</p>
            </div>
          ...
          <div className="flex items-center justify-between p-3 border-l-4 border-orange-500 bg-orange-50">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Technical issue reported - High Priority</p>
            </div>
...
function VendorsTab() {
  ...
  const filteredVendors = allVendors.filter(v => v.name.toLowerCase().includes(search.toLowerCase()));
          ...
          <tbody>
            {filteredVendors.map((vendor) => (
              <tr key={vendor.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-3">{vendor.owner}</td>
                ...
                <td className="px-6 py-3">{vendor.city}</td>
                <td className="px-6 py-3 font-semibold">{vendor.bookings}</td>
                <td className="px-6 py-3 font-semibold">₹{vendor.revenue}L</td>
                <td className="px-6 py-3">
