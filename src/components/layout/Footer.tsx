      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="lg:col-span-2">
            ...
            <p className="max-w-sm text-muted-foreground font-body leading-relaxed mb-8">
            ...
            <div>
              ...
              >
                <Input
                  ...
                  className="bg-background/50 border-border/50 font-body flex-1"
                />
                <Button
                  type="submit"
                  size="icon"
          ...
          <motion.div variants={itemVariants}>
            <h3 className="font-headline text-lg font-bold text-foreground mb-6">
              Quick Links
            </h3>
